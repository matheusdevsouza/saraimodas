      ...
      <div className="max-w-5xl mx-auto flex flex-col gap-10">
        ...
        <div className="flex flex-wrap justify-center gap-8 mb-6">
          ...
          >
            ...
            <a href="https://wa.me/5511932001120" target="_blank" rel="noopener noreferrer" className="text-gray-300 text-base mt-1 hover:text-primary-500 underline-offset-4 transition-colors">+55 11 93200-1120</a>
          </motion.div>
          <motion.div 
            initial={{ opacity: 0, y: 20 }} 
            animate={{ opacity: 1, y: 0 }} 
          ...
          >
            ...
            <a href="tel:5511932001120" className="text-gray-300 text-base mt-1 hover:text-primary-500 underline-offset-4 transition-colors">+55 11 93200-1120</a>
          </motion.div>
          <motion.div 
            initial={{ opacity: 0, y: 20 }} 
            animate={{ opacity: 1, y: 0 }} 
